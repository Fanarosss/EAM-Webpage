    ...
    <div class="bs-grid">
      ...
      <div class="bs-item2">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="http://localhost/student/student_book_sel.php">Select</a></li>
  ...
  <div class="bs2-grid">
    ...
    <div class="Book-Selection-Forms">
      <ul class="nav nav-tabs" style="margin-bottom: 2em; display: grid; grid-template-columns: auto auto auto auto auto;">
        <li class="nav-item">
          <a class="nav-link" href="http://localhost/student/student_new_form1.php" style="padding-left: 2em; padding-right: 2em;">Class Selection</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="http://localhost/student/student_new_form2.php" style="padding-left: 2em; padding-right: 2em;">Book Selection</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if(!isset($_SESSION['selected_books'])){
            ...
            if(isset($_SESSION['selected_books']) && (count($_SESSION['selected_books']) == 0)){
              echo 'disabled';}}?>"
          href="http://localhost/student/student_new_form3.php" style="padding-left: 2em; padding-right: 2em;">Pickup Point</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="http://localhost/student/student_new_form4.php" style="padding-left: 2em; padding-right: 2em;">Confirmation</a>
        </li>
      ...
      <div class="selection-cart">
        ...
        if (isset($_SESSION['selected_books'])){
          while($count < count($_SESSION['selected_books'])){
            $bookid = $_SESSION['selected_books'][$count]['id'];
            echo '<tr>
                    <th scope="row">'.$_SESSION['selected_books'][$count]['title'].'</th>
                    <td>'.$_SESSION['selected_books'][$count]['author'].'</td>
                    <td>'.$_SESSION['selected_books'][$count]['publications'].'</td>
                    <td>'.$_SESSION['selected_books'][$count]['id'].'</td>
                    <td><a class="btn btn-danger btn-sm" href="http://localhost/student/selected_books.php?action=delete&id='.$bookid.'"><i class="fas fa-trash-alt"></i> Delete</a></td>
                  </tr>';
            $count++;
          }
        }else{
          echo '<tr><p>No books selected.<p></tr>';
        }
        echo  '</tbody>
              </table>';
        ?>
      </div>
      <a role="button" class="btn btn-primary btn-lg" href="http://localhost/student/student_new_form2.php">Go back</a>
    </div>
  </div>
</body>
</html>
