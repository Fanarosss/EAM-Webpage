    ...
    <div class="Book-Selection-Forms">
      <ul class="nav nav-tabs" style="margin-bottom: 2em; display: grid; grid-template-columns: auto auto auto auto auto;">
        ...
        <li class="nav-item" style="margin-right: 0px; float: right;">
          <a href="http://localhost/student/selected_books.php" style="float: right;">
            ...
            if (mysqli_num_rows($result2) > 0){
              ...
              while($row = $result->fetch_assoc()){
                ...
                echo '<div class="btn">
                      ...
                      <form method="post" action="http://localhost/student/student_new_form2.php?action=add&id='.$row['BId'].'">
      ...
      <form method="post" action="http://localhost/student/student_book_sel.php">
        <a role="button" class="btn btn-primary btn-lg <?php if(!isset($_SESSION['selected_books'])){
        echo 'disabled';
      }else{
        if(isset($_SESSION['selected_books']) && (count($_SESSION['selected_books']) == 0)){
          echo 'disabled';}}?>"
        style="margin-top: 2em;" href="http://localhost/student/student_new_form3.php">Proceed</a>
