    ...
    <div class="Book-Selection-Forms">
      <ul class="nav nav-tabs" style="margin-bottom: 2em; display: grid; grid-template-columns: auto auto auto auto auto;">
        ...
        <li class="nav-item" style="margin-right: 0px; float: right;">
          <a href="http://localhost/student/selected_classes.php" style="float: right;">
            ...
            if (mysqli_num_rows($result) > 0) {
              while($row = $result->fetch_assoc()){
                ...
                echo  '<div class="btn">
                      ...
                      <form method="post" action="http://localhost/student/student_new_form1.php?action=add&id='.$row['Id'].'">
      ...
      <div class="button-row">
        <form method="post" action="http://localhost/student/student_book_sel.php">
          ...
          if(isset($_SESSION['selected_class']) && (count($_SESSION['selected_class']) == 0)){
            echo 'disabled';}}?>"
          style="margin-top: 2em;" href="http://localhost/student/student_new_form2.php">Proceed</a>
