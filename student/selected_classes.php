...
<body>
  ...
  <div class="bs2-grid">
    ...
    <div class="Book-Selection-Forms">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if(!isset($_SESSION['selected_class'])){
            ...
            if(isset($_SESSION['selected_class']) && (count($_SESSION['selected_class']) == 0)){
              echo 'disabled';}}?>"
            href="http://localhost/student/student_new_form2.php" style="padding-left: 2em; padding-right: 2em;">Book Selection</a>
        </li>
        <li class="nav-item">
        ...
        if (isset($_SESSION['selected_class'])){
          while($count < count($_SESSION['selected_class'])){
            ...
            echo '<tr>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="http://localhost/student/selected_classes.php?action=delete&id='.$classid.'"><i class="fas fa-trash-alt"></i> Delete</a></td>
                  </tr>';
            $count++;
          }
        }else{
      ...
      <a role="button" class="btn btn-primary btn-lg" href="http://localhost/student/student_new_form1.php">Go back</a>
    </div>
  </div>
</body>
</html>
