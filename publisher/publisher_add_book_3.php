  ...
  <div class="bs2-grid">
    ...
    <div class="Book-Selection-Forms">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/publisher/publisher_add_book_3.php" style="padding-left: 2em; padding-right: 2em;">Book Files</a>
        </li>
        <li class="nav-item">
      ...
      <div class="jumbotron2">
        ...
        <form action="publisher_add_book_3.php" method="POST" enctype="multipart/form-data">
          <fieldset>
            ...
            <hr class="my-4">
            <button type="submit" formaction="http://localhost/publisher/publisher_add_book_3.php?action=submit" class="btn btn-primary" name="submit-check">Submit</button>
            <button type="submit" formaction="http://localhost/publisher/publisher_add_book_3.php?action=reset" formnovalidate class="btn btn-primary" name="reset">Reset</button>
          </fieldset>
        </form>
      </div>
    </div>
