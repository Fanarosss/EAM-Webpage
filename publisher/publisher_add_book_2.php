  ...
  <div class="bs2-grid">
    ...
    <div class="Book-Selection-Forms">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/publisher/publisher_add_book_2.php" style="padding-left: 2em; padding-right: 2em;">Book Info</a>
        </li>
        <li class="nav-item">
      ...
      <div class="jumbotron2">
        ...
        <hr class="my-4">
        <form action="http://localhost/publisher/publisher_add_book_2.php" method="POST">
          <fieldset>
            ...
            <hr class="my-4">
            <button type="submit" formaction="http://localhost/publisher/publisher_add_book_2.php?action=submit" class="btn btn-primary" name="submit-check">Submit</button>
            <button type="submit" formaction="http://localhost/publisher/publisher_add_book_2.php?action=reset" formnovalidate class="btn btn-primary" name="reset">Reset</button>
          </fieldset>
        </form>
      </div>
    </div>
