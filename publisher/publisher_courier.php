...
<body>
  ...
  <div class="bs2-grid">
    ...
    <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item" style="padding-bottom:2em">
        <a class="nav-link active" href="http://localhost/publisher/publisher_courier.php">Courier Service</a>
      </li>
      <li class="nav-item" style="padding-bottom:2em">
    ...
    <div class="bs-item3">
      <div class="jumbotron2">
        <img src="http://localhost/images/UnderCon.jpg" alt="Under Construction!" style="display: block;margin-left: auto;margin-right: auto;width:500px;">
      </div>
    </div>
  </div>
</body>
