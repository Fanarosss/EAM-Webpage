  ...
  <div class="bs2-grid">
    ...
    <ul class="nav nav-pills flex-column">
      <li class="nav-item" style="padding-bottom:2em">
        <a class="nav-link active" href="http://localhost/publisher/publisher_home.php">Home</a>
      </li>
      <li class="nav-item" style="padding-bottom:2em">
    ...
    <div class="bs-item3">
      <div class="jumbotron2">
        ...
        <p class="lead">
          <a class="btn btn-primary btn-lg" href="http://localhost/publisher/publisher_settings.php" role="button"><i class="fas fa-cogs"></i> Settings</a>
        </p>
      </div>
    </div>
  </div>
